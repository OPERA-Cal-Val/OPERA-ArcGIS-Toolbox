...
(a)	Download OPERA DSWx-HLS granules from PO.DAAC.  
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Download OPERA RTC-S1 granules from ASF DAAC.<br>   
(b)	Filter DSWx-HLS, DSWx-S1, DIST-ALERT-HLS, DIST-ANN-HLS and RTC-S1 granules from (a) a previously downloaded stack of granules based on a user-provided date range and Area of Interest (AOI) or (b) granules currently existing on the ArcGIS Pro contents pane. <br>    
