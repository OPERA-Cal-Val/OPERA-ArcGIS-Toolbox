...
-	a ‘Dependency’ folder color ramp files (.clr) and symbology files (.lyrx) to preserve original OPERA DSWx-HLS, DSWx-S1, DIST-ALERT-HLS, DIST-ANN-HLS and RTC-S1 color ramp information during geoprocessing.
